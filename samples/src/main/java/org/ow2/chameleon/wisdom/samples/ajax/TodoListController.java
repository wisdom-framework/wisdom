...
public class TodoListController extends DefaultController {
    ...
    public Result delete() {
        removeTaskById(context().parameterFromPathAsInteger("id"));
        return ok();
    }
    ...
    public Result update() {
        boolean completed = context().parameterAsBoolean("completed");
        Task task = getTaskById(context().parameterFromPath("id"));
        if (task == null) {
