...
import org.ow2.chameleon.wisdom.api.utils.CookieDataCodec;
...
public class SessionCookieImpl implements SessionCookie {
    ...
    public SessionCookieImpl(Crypto crypto, ApplicationConfiguration configuration) {
        ...
        Integer sessionExpireTimeInSeconds = configuration
                .getInteger(SessionCookie.sessionExpireTimeInSeconds);
        ...
        this.applicationCookiePrefix = configuration
                .getOrDie(SessionCookie.applicationCookiePrefix);
    }
