 ...
 */
public class WisdomHandlerSnoop extends SimpleChannelInboundHandler<HttpObject> {
    ...
    public WisdomHandlerSnoop(ServiceAccessor accessor) {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, HttpObject msg) {
        if (msg instanceof HttpRequest) {
            ...
            buf.setLength(0);
            buf.append("WELCOME TO THE WISDOM SERVER\r\n");
            buf.append("============================\r\n");
