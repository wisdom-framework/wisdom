 ...
 */
public final class FromStringBasedConverter<T> implements ParameterConverter<T> {
     ...
     * .FromStringBasedConverter} (i.e. has a static 'fromString' method taking a single String as argument). If so,
     * creates a new instance of converter for this type.
     *
     * @param clazz the class
     * @return a {@link org.wisdom.content.converters.FromStringBasedConverter} if the given class is eligible,
    ...
    public T fromString(String input) throws IllegalArgumentException {
        try {
            ...
            LoggerFactory.getLogger(this.getClass())
                    .error("Cannot create an instance of {} from \"{}\" using the 'fromString' method",
