...
// sample is not included (no-default)
assertThat(bundle.getEntry("sample/WelcomeController.class")).isNull()
// resources not embedded (no-default)
assertThat(bundle.getEntry("assets/cat.jpg")).isNull()
