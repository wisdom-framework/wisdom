...
public class BoneCP implements Closeable {
    ...
    /**
     * The driver instance if given by the driver properties.
     */
    ...
    private Connection getConnection(String url, String username, String password, Properties props) throws SQLException {
        Connection result;
        if (this.driver == null) {
            if (props != null) {
                props.remove(DRIVER_INSTANCE_PROPERTY);
            ...
            if (props != null) {
                props.remove(DRIVER_INSTANCE_PROPERTY);
                result = this.driver.connect(url, props);
            } else {
                ...
                result = this.driver.connect(url, info);
            }
        }
        return result;
    }
